      ...
      <div class="card border-success mb-3" style="width: 18rem;" >
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type='text' class='form-control' value="<?php echo $captura[0] ?>" placeholder="ID Categoria" name="id_categoria" required="true" disabled="true">
              </div>
                <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?php echo $captura[2] ?>" placeholder="ID Producto" name="id_producto" required="true" disabled="true">
              </div>
