          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                  ...
                  <div >
                      <button type="button" class="btn btn-success btn-lg btn-block"><a href="Nueva.html" >Producto Nuevo  <i class="fa fa-plus-square"></i></a></button>
                  </div>
                  <div align="right" class="container-fluid" style="width: 70%">
                    ...
                    if($tipo=="checkbox"){
                    echo '<form method="POST" action="../Ventas/ventaNuevo.php">';
                    ...
                    while ($filas = mysqli_fetch_assoc($resultado)) {
                      ...
                      echo '</td>';
                      echo '<td><input type="checkbox" value="'.$filas['nombre_producto'].'" name="check_list[]" class="form-check-input" id="exampleCheck1" ></td>';
                      echo '</tr>';
                    }

                    echo '</table>';
                    echo '<div align="center" class="container-fluid">
...
?>
  ...
  <script type="text/javascript">
    $(document).ready(function () {
      ...
      $.notify({
        icon: 'pe-7s-gift',
        message: "Bienvenido a Productos su Supremacia."
