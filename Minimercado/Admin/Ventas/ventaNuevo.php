          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                  ...
                  <div >
                      <button type="button" class="btn btn-success btn-lg btn-block"><a href="Nueva.html" >Nueva venta <i class="fa fa-plus-square"></i></a></button>
                  </div>
                      <div class="col-md-12">
                          <div class="panel panel-default">
                              <div class="panel-body">
                                  <button type="button" class="btn btn-success">Agregar Producto <i class="fa fa-plus-square"></i></button>
                                  <hr>
